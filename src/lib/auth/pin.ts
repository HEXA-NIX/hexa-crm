...
async function sha256Hex(message: string): Promise<string> {
  ...
  // HTTP access by LAN IP is not a secure context, so Web Crypto may be
  // unavailable. Keep local login working without bundling Node's crypto
  // module into the browser (Vite externalizes it to an empty shim).
